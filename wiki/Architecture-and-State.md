...
Filesystem reconciliation validates the intended home boundary, backs up conflicts, and uses atomic replace for state/config output. Manual checkpoints persist exact instructions and exit 20.
